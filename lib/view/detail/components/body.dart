  ...
  shoeInfo(width, height) {
    return FadeAnimation(
      ...
      child: Container(
        ...
        height: height / 9,
        child: Text(
            "Step up your style and performance with Air Max sneakers – the perfect fusion of comfort, innovation, and iconic design. Elevate yourself.",
      ...
      child: Row(
        children: [
          ...
          Padding(
            ...
            child: Text('฿${widget.model.price.round()}',
